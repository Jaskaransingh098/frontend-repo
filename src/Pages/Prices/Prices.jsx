...
function Prices() {
  ...
  return (
    <div className="pricing-container">
      <motion.h1 className="pricing-title" variants={contentVariants} initial="hidden" animate="visible">InnoLink Pro Plans</motion.h1>
      <motion.p className="pricing-subtitle" variants={contentVariants} initial="hidden" animate="visible">
        Premium solution to help your startup grow and succeed
      </motion.p>
      <motion.div className="pricing-cards">
        <motion.div className="pricing-card essential-card" variants={contentVariants} initial="hidden" animate="visible">
          <h2>Essential {isPro && activePlan === "Essential" && <span style={{color: 'green'}}>(Active)</span>}</h2>
          <h3 className="price">
            &#8377;150<span>/ mo</span>
          </h3>
        ...
        <motion.div className="pricing-card growth-card" variants={contentVariants} initial="hidden" animate="visible">
          <h2>Professional {isPro && activePlan === "Professional" && <span style={{color: 'green'}}>(Active)</span>}</h2>
          <h3 className="price">
            &#8377; 300 <span>/ mo</span>
          </h3>
          <ul className="card-features">
          ...
          <motion.button className="cta-button" onClick={() => handleGetStarted(300, "Professional")} variants={buttonVariants} initial="hidden" animate="visible">
            <span className="button-text">
              Get Started <ArrowRightCircle size={18} />
            </span>
          </motion.button>
        ...
        <motion.div className="pricing-card enterprise-card" variants={contentVariants} initial="hidden" animate="visible">
          <h2>Enterprise {isPro && activePlan === "Enterprise" && <span style={{color: 'green'}}>(Active)</span>}</h2>
          <h3 className="price">
            &#8377; 500 <span>/ mo</span>
          </h3>
          <ul className="card-features">
