    ...
    <section className="gov-section">
      ...
      >
        ...
        <div className="definition-texts">
          ...
          <p>
            Startup India is a flagship initiative launched by the Government of
            India in 2016 to build a strong ecosystem that fosters innovation
            and supports budding entrepreneurs. It aims to transform India into
            a nation of job creators instead of job seekers. The initiative
            offers:
          </p>
          <ol>
            <li>
          ...
          <p className="bottom-text">
            Over 100,000 startups have been recognized under the scheme, making
            India the 3rd largest startup ecosystem globally.
          </p>
        </div>
      </div>
      ...
      <div className="initiative-summary" data-aos="fade-up">
        ...
        <ul>
          <li>
            ...
            Policy support with simplified regulations, tax benefits, and patent
            support
          </li>
          <li>
            <FaCheckCircle className="check-icon" />
        ...
        <p className="highlighted-stat">
          Over <strong>100,000</strong> startups have been recognized under the
          scheme, making India the <strong>3rd largest</strong> startup
          ecosystem globally.
        </p>
      </div>
        ...
        <div className="steps-vertical">
          ...
          <div className="triangle-step">
            ...
            <div className="step-content">
              ...
              <p>
                Once approved, access funding, tax relief, mentorship, and legal
                support.
              </p>
            </div>
          </div>
          ...
          <div className="eligibility-text">
            ...
            <ul className="eligibility-timeline">
              ...
              <li>
                <span className="dot"></span>
                <p>
                  <strong>Offers innovation</strong> or a unique product/service
                </p>
              </li>
              <li>
                <span className="dot"></span>
      ...
      <div className="schemes-section" data-aos="fade-up">
        ...
        <p className="subtitle">These schemes offer funding, protection, and market access:</p>
        <div className="schemes-grid">
          {schemes.map((scheme, index) => (
            <div
              key={index}
              className={`scheme-card ${scheme.size} ${index === schemes.length - 1 ? "last-card" : ""}`}
              // data-aos="zoom-in"
      ...
      <div className="gov-button-container" data-aos="zoom-in-up">
        ...
        <p className="gov-button-subtitle">
          Join India’s thriving startup ecosystem with government-backed support. Apply now or learn more about the opportunities awaiting your venture.
        </p>
